...
* ramsey/uuid-doctrine follows a superset of **[PSR-12 coding standard][psr-12]**.
  Please ensure your code does, too. _Hint: run `composer dev:lint` to check._
* Please **write tests** for any new features you add.
* Please **ensure that tests pass** before submitting your pull request.
  ramsey/uuid-doctrine automatically runs tests for pull requests. However,
...
To develop this project, you will need [PHP](https://www.php.net) 5.4 or greater
